...
For articles that are published as Open Access (see Open Access Publishing), the final published article (i.e., the publisher’s version of record) can be made publicly available in the STI Repository.
...
## Preprints
SMD-funded researchers are encouraged to post their manuscripts to community-appropriate preprint servers such as arXiv or the Earth and Space Science Open Archive, though this is not a requirement under SPD-41a and does not currently satisfy requirements for public access as described above.  
